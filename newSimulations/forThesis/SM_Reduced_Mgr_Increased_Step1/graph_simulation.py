...
SeniorManager管理スパンを削減し、Manager管理スパンを増加させる実験パターン1。
InterviewBasedからの変更:
- SeniorManager: 10-15 → 8-11 (平均 12.5 → 9.5, -24%)
- Manager: 5-10 → 8-12 (平均 7.5 → 10, +33%)
"""
...
CHILD_RANGES = {
    "CXO": (15, 20),             # 平均 17.5 (変更なし)
    "Director": (10, 15),        # 平均 12.5 (変更なし)
    "SeniorManager": (8, 11),    # 平均 9.5 (-24% from InterviewBased)
    "Manager": (8, 12),          # 平均 10 (+33% from InterviewBased)
    "Player": (0, 0),
}
...
def main() -> None:
    ...
    lines = [
        "# SM_Reduced_Mgr_Increased_Step1 Simulation Result",
        "",
