"""
ReducedSeniorSpan_Adjusted - Adjusted for ~25,000 nodes comparison.

This scenario reduces SeniorManager management span (7-10) while maintaining
comparable organization size to InterviewBased for fair comparison.
Target: Achieve ~25,000 nodes with reduced SeniorManager load.
"""
...
CHILD_RANGES = {
    "CXO": (17, 22),             # ★ Increased for larger org size
    "Director": (13, 17),        # ★ Increased for larger org size
    "SeniorManager": (7, 10),    # ★ Reduced (vs InterviewBased 10-15)
    "Manager": (7, 10),          # ★ Balanced to maintain org size
    "Player": (0, 0),
}
