...
SeniorManager管理スパンを削減し、Manager管理スパンを増加させる実験パターン4。
InterviewBasedからの変更:
- SeniorManager: 10-15 → 4-6 (平均 12.5 → 5, -60%)
- Manager: 5-10 → 12-16 (平均 7.5 → 14, +87%)
"""
...
CHILD_RANGES = {
    ...
    "SeniorManager": (4, 6),     # 平均 5 (-60% from InterviewBased)
    "Manager": (18, 22),         # 平均 20 (+167%) ※ノード数維持のため調整
    "Player": (0, 0),
}
