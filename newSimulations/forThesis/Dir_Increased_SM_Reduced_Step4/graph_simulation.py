"""
Dir_Increased_SM_Reduced_Step4: Director管理スパン増加、SeniorManager管理スパン削減

パラメータ変更:
- Director→SM: [18, 23] (avg 20.5, +64%)
- SM→Mgr: [4, 6] (avg 5.0, -60%)
- Mgr→Player: [10, 13] (avg 11.5, +53%) ※ノード数維持のため調整
"""
...
CHILD_RANGES = {
    "CXO": (15, 20),
    "Director": (18, 23),      # 増加: [10,15] → [18,23]
    "SeniorManager": (4, 6),   # 削減: [10,15] → [4,6]
    "Manager": (10, 13),       # 調整: [5,10] → [10,13] ノード数維持
    "Player": (0, 0),
}
