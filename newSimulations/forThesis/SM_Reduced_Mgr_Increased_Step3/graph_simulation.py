...
SeniorManager管理スパンを削減し、Manager管理スパンを増加させる実験パターン3。
InterviewBasedからの変更:
- SeniorManager: 10-15 → 5-7 (平均 12.5 → 6, -52%)
- Manager: 5-10 → 11-15 (平均 7.5 → 13, +73%)
"""
...
CHILD_RANGES = {
    ...
    "SeniorManager": (5, 7),     # 平均 6 (-52% from InterviewBased)
    "Manager": (15, 19),         # 平均 17 (+127%) ※ノード数維持のため調整
    "Player": (0, 0),
}
...
def main() -> None:
    ...
    lines = [
        "# SM_Reduced_Mgr_Increased_Step3 Simulation Result",
        "",
