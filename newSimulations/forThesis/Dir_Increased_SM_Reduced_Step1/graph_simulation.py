"""
Dir_Increased_SM_Reduced_Step1: Director管理スパン増加、SeniorManager管理スパン削減

パラメータ変更:
- Director→SM: [12, 17] (avg 14.5, +16%)
- SM→Mgr: [8, 11] (avg 9.5, -24%)
- Mgr→Player: [7, 10] (avg 8.5, +13%) ※ノード数維持のため調整
"""
...
CHILD_RANGES = {
    "CXO": (15, 20),
    "Director": (12, 17),      # 増加: [10,15] → [12,17]
    "SeniorManager": (8, 11),  # 削減: [10,15] → [8,11]
    "Manager": (7, 10),        # 調整: [5,10] → [7,10] ノード数維持
    "Player": (0, 0),
}
...
def main() -> None:
    ...
    lines = [
        "# Dir_Increased_SM_Reduced_Step1 Simulation Result",
        "",
