...
SeniorManager管理スパンを削減し、Manager管理スパンを増加させる実験パターン2。
InterviewBasedからの変更:
- SeniorManager: 10-15 → 6-9 (平均 12.5 → 7.5, -40%)
- Manager: 5-10 → 10-14 (平均 7.5 → 12, +60%)
"""
...
CHILD_RANGES = {
    ...
    "SeniorManager": (6, 9),     # 平均 7.5 (-40% from InterviewBased)
    "Manager": (12, 16),         # 平均 14 (+87%) ※ノード数維持のため調整
    "Player": (0, 0),
}
...
def main() -> None:
    ...
    lines = [
        "# SM_Reduced_Mgr_Increased_Step2 Simulation Result",
        "",
