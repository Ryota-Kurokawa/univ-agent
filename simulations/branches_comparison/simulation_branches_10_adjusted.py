...
if __name__ == "__main__":
    print("=== 分岐数10のシミュレーション（階層調整版） ===\n")

    # 4階層、分岐数10（ノード数: 1111）
    print("組織構造: 4階層（CEO, CTO, Manager, Engineer）")
    print("分岐数: 10")
    org = OrganizationGraph(branches=10, height=3, structure_type="baseline")
